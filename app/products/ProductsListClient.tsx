...
export default function ProductsListClient({ products }: { products: Product[] }) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-8 py-8 md:py-12">
      {/* ── Toolbar ────────────────────────────────────────────── */}
      <div className="flex items-center justify-between gap-3 pb-4 border-b border-[var(--color-shas-line)]">
      ...
      {filterOpen && (hasSizeFilter || hasSaleFilter) && (
        <div className="border-b border-[var(--color-shas-line)] pb-6 pt-5 space-y-5 reveal">
          {hasSizeFilter && (
            <div>
      ...
      {/* ── Active-filter summary chips (always visible when filters active) ── */}
