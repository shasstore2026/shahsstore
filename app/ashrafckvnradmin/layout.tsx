...
const navSections: NavSection[] = [
  {
    section: "Dashboards",
    items: [
      { label: "Order Dashboard", href: "/ashrafckvnradmin", icon: "▦" },
      { label: "Stock Dashboard", href: "/ashrafckvnradmin/stock", icon: "📦" },
      { label: "Revenue Dashboard", href: "/ashrafckvnradmin/revenue", icon: "₹" },
    ],
  },
  {
    section: "Shirts",
    items: [
      { label: "All Products", href: "/ashrafckvnradmin/products", icon: "☰" },
      { label: "Add New Shirt", href: "/ashrafckvnradmin/products/new", icon: "+" },
      { label: "Shirt Styles", href: "/ashrafckvnradmin/shirt-styles", icon: "◈" },
    ],
  },
  {
    section: "Orders",
    items: [
      { label: "Orders", href: "/ashrafckvnradmin/orders", icon: "◎" },
    ],
  },
  {
    section: "Delivery",
    items: [
      { label: "Delivery Charges", href: "/ashrafckvnradmin/delivery-settings", icon: "🚚" },
    ],
  },
  {
    section: "Site Control",
    items: [
      { label: "Maintenance Mode", href: "/ashrafckvnradmin/maintenance-mode", icon: "🚧" },
    ],
  },
  {
    section: "Website Content",
    items: [
      { label: "Top Notification", href: "/ashrafckvnradmin/top-notification", icon: "📢" },
      { label: "Hero Banner", href: "/ashrafckvnradmin/hero-banner", icon: "◻" },
      { label: "Marquee Banner", href: "/ashrafckvnradmin/marquee", icon: "≡" },
      { label: "Help Content", href: "/ashrafckvnradmin/help-content", icon: "?" },
      { label: "Company Content", href: "/ashrafckvnradmin/company-content", icon: "◉" },
    ],
  },
];
...
export default function AdminLayout({
  ...
  const isLoginPage = pathname === "/ashrafckvnradmin/login";
