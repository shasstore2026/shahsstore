...
export default function NewProductClient({ styles }: { styles: ShirtStyle[] }) {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      router.push("/ashrafckvnradmin/products");
    } catch (err: unknown) {
  ...
  return (
    <div className="max-w-2xl">
      ...
      <form onSubmit={handleSubmit} noValidate className="bg-white border border-stone-100 p-8 space-y-6">
        ...
        {/* Shirt Style / Category */}
        <div>
          <label className="text-xs tracking-widest uppercase text-stone-500 block mb-2">Shirt Style / Category *</label>
          <select
            name="category"
