...
import { deleteShirtStyle } from "@/lib/actions";
...
export default function AdminShirtStylesClient({ styles }: { styles: Style[] }) {
    ...
    <>
              ...
              <tr key={style.id} className="hover:bg-stone-50 transition-colors">
                ...
                <td className="px-6 py-4">
                  <div className="flex gap-3">
                    <Link
                      href={`/ashrafckvnradmin/shirt-styles/${style.id}`}
      ...
      <DeleteConfirmModal
        ...
        onConfirm={async (phrase) => {
          ...
          await deleteShirtStyle(deleteTarget.id, phrase);
