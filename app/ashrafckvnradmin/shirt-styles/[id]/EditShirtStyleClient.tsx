...
import { updateShirtStyle } from "@/lib/actions";
...
export default function EditShirtStyleClient({ style }: { style: ShirtStyle }) {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (orderRaw) {
      const result = await validateStyleOrder(orderRaw, style.id);
    ...
    try {
      await updateShirtStyle(style.id, formData);
